 ...
 */
    ...
    (() => {
        ...
        if (document.querySelector(".about__slider")) {
            ...
            function sliderInit() {
                if (!aboutSlider) aboutSlider = new core(".about__slider", {
            ...
            window.addEventListener("resize", (function(e) {
                ...
                if (windowWidth <= mediaQuerySize) sliderInit(); else sliderDestroy();
            }));
        ...
        if (document.querySelector(".how-we-work__slider")) {
            ...
            mediaQuerySize = 700;
            function sliderInit() {
                if (!worksSlider) worksSlider = new core(".how-we-work__slider", {
                    modules: [ Navigation ],
                    observer: true,
                    observeParents: true,
                    speed: 800,
        ...
        if (document.querySelector(".cooperation-formats__slider")) {
            var cooperationFormatsSlider = null;
            mediaQuerySize = 700;
            function sliderInit() {
                if (!cooperationFormatsSlider) cooperationFormatsSlider = new core(".cooperation-formats__slider", {
                    modules: [ Navigation ],
                    observer: true,
                    observeParents: true,
                    speed: 800,
        ...
        if (document.querySelector(".partners__slider")) {
            ...
            mediaQuerySize = 700;
            function sliderInit() {
                if (!partnersSlider) partnersSlider = new core(".partners__slider", {
                    modules: [ Navigation, Grid ],
                    observer: true,
                    observeParents: true,
                    speed: 800,
...
***************************************************************************** */
        ...
        if (catalofArrows) catalofArrows.forEach((arrow => {
            arrow.addEventListener("click", (event => {
                ...
                document.querySelectorAll(".catalog__column").forEach((column => {
                    if (column !== currentColumn) column.classList.remove("_active");
                }));
